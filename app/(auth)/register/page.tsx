  ...
  return (
    <div className="glass rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-8 border-white/5 shadow-2xl flex flex-col justify-center max-h-full overflow-y-auto no-scrollbar">
      <div className="text-center mb-4 md:mb-5">
        <h1 className="text-xl md:text-2xl font-bold tracking-tight mb-0.5">Create account</h1>
        <p className="text-white/50 text-[12px] md:text-sm font-medium">Start your free 14-day trial today</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5 md:space-y-4">
        ...
        <div className="space-y-2.5 md:space-y-3">
          <div className="space-y-1 md:space-y-1.5">
            <Label htmlFor="name" className="text-xs md:text-sm font-semibold text-white/70 ml-1">Full name</Label>
            <Input
          ...
          <div className="space-y-1 md:space-y-1.5">
            <Label htmlFor="email" className="text-xs md:text-sm font-semibold text-white/70 ml-1">Work email</Label>
            <Input
          ...
          <div className="space-y-1 md:space-y-1.5">
            <Label htmlFor="password" className="text-xs md:text-sm font-semibold text-white/70 ml-1">Password</Label>
        ...
        <div className="space-y-3 md:space-y-4 pt-1 md:pt-2">
          <div className="flex items-start space-x-3 bg-white/5 p-2.5 md:p-3 rounded-xl border border-white/5">
            <input 
              type="checkbox" 
              id="terms" 
              required
