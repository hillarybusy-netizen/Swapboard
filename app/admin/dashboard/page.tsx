    ...
    <div className="space-y-10 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-1 md:px-2">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/analytics"
            className="px-4 py-2 rounded-lg bg-gold/10 hover:bg-gold/20 border border-gold/30 text-gold text-xs font-black uppercase tracking-widest transition-all"
          >
            Analytics Report
          </Link>
          <ExportReportDropdown data={{ metrics, swaps, orgName: org?.name ?? "Organization" }} />
          <AddShiftDialog orgId={orgId} departments={departments} profiles={workerProfiles} />
        </div>
      </div>
